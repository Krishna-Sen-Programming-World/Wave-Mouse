...
class HandDetector:
    ...
    def findHands(self, img, draw=True):
        ...
        if self.results.multi_handedness:
            handedness = self.results.multi_handedness[0].classification[0].label  # 'Left' or 'Right'
...
def generate_frames():
    ...
    while True:
        ...
        img_for_annotations, handedness = detector.findHands(img_for_annotations)
        ...
        if len(lmList) != 0:
            ...
            if handedness == 'Left':
                if lmList[tipIds[0]][1] < lmList[tipIds[0] - 1][1]:
                    fingers.append(0)  # Thumb out is treated as thumb in for left hand
                else:
                    fingers.append(1)
            else:
                if lmList[tipIds[0]][1] > lmList[tipIds[0] - 1][1]:
